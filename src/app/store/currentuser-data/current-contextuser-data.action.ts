...
export enum ActionTypes {
  ...
  DELETE_CURRENT_USER_REQUEST = '[Users Data] Delete Current User Request',
...
export class CurrentDeleteUsersRequestAction implements Action {
  readonly type = ActionTypes.DELETE_CURRENT_USER_REQUEST;
...
export type Actions =
  ...
  | CurrentDeleteUsersRequestAction
