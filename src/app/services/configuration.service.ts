...
export class ConfigurationService {
  ...
  set showDailyStockTrade(value: boolean) {
    this._showDailytrade = value;
    this.saveToLocalStore(value, DBkeys.SHOW_DAILYSTOCK_TRADE);
  }

  get showDailyStockTrade() {
    return this._showDailytrade != null ? this._showDailytrade : ConfigurationService.defaultShowDailyStockTrade;
  }
  ...
  public static readonly defaultShowDailyStockTrade: boolean = true;
  ...
  public fallbackBaseUrl = 'https://urbanhood.org';
  // ***End of defaults***
  ...
  private _showDailytrade: boolean = null;
  ...
  private loadLocalChanges() {
    ...
    if (this.localStorage.exists(DBkeys.SHOW_DAILYSTOCK_TRADE)) {
      this._showDailytrade = this.localStorage.getDataObject<boolean>(DBkeys.SHOW_DAILYSTOCK_TRADE);
    }
  ...
  public import(jsonValue: string) {
    ...
    if (jsonValue) {
      ...
      if (importValue.showDailyStockTrade != null) {
        this.showDailyStockTrade = importValue.showDailyStockTrade;
      }
  ...
  public export(changesOnly = true): string {
    const exportValue: UserConfiguration = {
      ...
      showDailyStockTrade: changesOnly ? this._showDailytrade : this.showDailyStockTrade,
  ...
  public clearLocalChanges() {
    ...
    this.localStorage.deleteData(DBkeys.SHOW_DAILYSTOCK_TRADE);
