...
export class LocalStoreManager {
  ...
  public saveSyncedSessionData(data: any, key = LocalStoreManager.DBKEY_USER_DATA) {
    //console.log("saveSyncedSessionData " + JSON.stringify(data) + "Key " + key);
    this.testForInvalidKeys(key);
    localStorage.removeItem(key);
  ...
  private localStorageSetItem(key: string, data: any) {
    //console.log("localStorageSetItem Key:" + key);
    //console.log("localStorageSetItem Data:" + JSON.stringify(data));
