...
import { AlertService, AppTranslationService, ConfigurationService, AccountService, MessageSeverity, Utilities } from '../../../services';
...
export class UserPreferencesComponent {
  ...
  homePages: PageInfo[] = [
    { title: 'Dashboard', icon: 'dashboard', path: '/auth/dashboard', isDefault: true },
    { title: 'Courses', icon: 'notes', path: '/auth/courses', isDefault: false },
