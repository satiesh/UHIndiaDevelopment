...
@Component({
  selector: 'app-freestockcontrol-list',
  templateUrl: './freestock-control.component.html',
  styleUrls: ['./freestock-control.component.scss'],
  animations: [fadeInOut]
})

export class FreeStockControlComponent implements OnInit, AfterViewInit {
