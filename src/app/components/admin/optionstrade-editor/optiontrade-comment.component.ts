...
@Component({
  selector: 'app-optionstrade-comment',
  templateUrl: './optiontrade-comment.component.html',
  styleUrls: ['./optiontrade-comment.component.scss']
})
export class OptionsTradeCommentComponent implements OnChanges, OnDestroy, AfterViewInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<OptionsTradeCommentComponent>,
