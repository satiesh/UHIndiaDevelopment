...
export class OpenTradesComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.selectOptionsTrade$ = this.store$.select(OptionsTradeStoreSelectors.selectOptionsTradeByDate(fromDate, toDate, this.authService.groupInfo));
