...
@Component({
  selector: 'app-closedtrades-list',
  templateUrl: './closedtrades.component.html',
  styleUrls: ['./closedtrades.component.scss'],
...
export class ClosedTradesComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.selectOptionsTrade$ = this.store$.select(OptionsTradeStoreSelectors.selectClosedOptionsTradeByDate(fromDate, toDate, this.authService.groupInfo));
