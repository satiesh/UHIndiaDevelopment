...
@Component({
  selector: 'app-alltrades-list',
  templateUrl: './alltrades.component.html',
  styleUrls: ['./alltrades.component.scss'],
  animations: [fadeInOut]
})

export class AllTradesComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.selectOptionsTrade$ = this.store$.select(OptionsTradeStoreSelectors.selectAllTradeByDate(fromDate, toDate, this.authService.groupInfo));
