...
@Component({
  selector: 'app-closedstocktrades-list',
  templateUrl: './closedstocktrades.component.html',
  styleUrls: ['./closedstocktrades.component.scss'],
  animations: [fadeInOut]
})

export class ClosedStockTradesComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.selectOptionsTrade$ = this.store$.select(OptionsTradeStoreSelectors.selectClosedStockTradeByDate(fromDate, toDate, this.authService.groupInfo));
